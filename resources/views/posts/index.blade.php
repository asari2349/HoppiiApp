            ...
            <div>
                <form action="{{ route('index') }}" method="GET">
                    ...
                    <div class = "sm:flex">
                        ...
                        <div class = "px-2" >
                            <select name="order" class = "py-2 my-2">
                                @if(isset($order))
                                    @if($order == "created_at")
                                        <option value="created_at" selected>日付</option>
                                        <option value="likes_count" >いいね数</option>
                                    @else($order == "likes_count")
                                        <option value="created_at">日付</option>
                                        <option value="likes_count" selected>いいね数</option>
                                    @endif
                                @else
                                    <option value="created_at">日付</option>
                                    <option value="likes_count" >いいね数</option>
